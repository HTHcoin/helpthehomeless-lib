 ...
 * ```javascript
 *
 * var uri = new URI('helpthehomeless:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('helpthehomeless:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6');
 * // true
 * ```
 *
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'helpthehomeless:') {
    throw new TypeError('Invalid helpthehomeless URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid helpthehomeless address');
  }
