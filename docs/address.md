# Helpthehomeless Address
Represents a Helpthehomeless address. Addresses are the most popular way to make Helpthehomeless transactions. See [the Helpthehomeless documentation](https://helpthehomeless-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/Altcoin-Cash/bitcore-helpthehomeless/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/Altcoin-Cash/bitcore-helpthehomeless/tree/master/lib/errors/spec.js).
