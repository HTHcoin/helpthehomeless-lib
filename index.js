...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of helpthehomeless-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of helpthehomeless.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._helpthehomeless);
global._helpthehomeless = bitcore.version;
...
bitcore.deps._ = require('lohelpthehomeless');
